...
public static partial class Strings
{
            ...
            foreach (var groupType in groupTypes)
            {
                ...
                foreach (var fieldInfo in groupType.GetFields(BindingFlags.Public | BindingFlags.Static))
                {
                    ...
                    switch (fieldValue)
                    {
                        ...
                        case Dictionary<MapInstanceType, LocalizedString> localeDictionary:

                            DeserializeDictionary(missingStrings, groupType, fieldInfo, fieldValue, serializedGroup, serializedValue, localeDictionary);
                            break;
                        ...
                        default:
                            {
                                ...
                                {
                                    Log.Error(new NotSupportedException($"Unsupported localization type for {groupType.Name}.{fieldInfo.Name}: {fieldInfo.FieldType.FullName}. Value: {fieldValue}"));
                                    break;
                                }
    ...
    public partial struct Attributes
    {
        public static Dictionary<int, LocalizedString> AttributeTypes = new Dictionary<int, LocalizedString>
        {
            ...
            {(int) MapAttribute.FishingSpot, @"Fishing Spot" },
        };
        ...
        public static LocalizedString FishingSpotBlock = @"Blocked?";

        public static LocalizedString FishingSpotType = @"Spot Type";

        public static LocalizedString FishingSpotDirection = @"Direction";
    }
...
Tick timer saved in server config.json.";
    ...
    public partial struct FishingSpotEditor
    {
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString copy = @"Copy Spot";

        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString fishes = @"Available Fishes";

        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString delete = @"Delete Spot";

        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString deleteprompt =
            @"Are you sure you want to delete this spot? This action cannot be reverted!";
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString New = @"New Spot";

        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString paste = @"Paste Spot";
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString title = @"Fishing Spots Editor";
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString undoprompt =
            @"Are you sure you want to undo changes made to this spot? This action cannot be reverted!";
        ...
        public static LocalizedString fishingtimemin = @"Fishing Time Min (MS)";
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public static LocalizedString fishingtimemax = @"Fishing Time Max (MS)";
    }
    ...
    public partial struct FishesEditor
    {
        ...
        public static LocalizedString deletefish = @"Delete";


        public static LocalizedString deleteprompt =
            @"Are you sure you want to delete this? This action cannot be reverted!";

        public static LocalizedString deletetitle = @"Delete Fish";

        public static LocalizedString duplicatefish = @"Duplicate";
        ...
        public static LocalizedString title = @"Fishes Editor";

        public static LocalizedString undo = @"Undo Changes";

        public static LocalizedString undoprompt =
            @"Are you sure you want to undo changes made to this? This action cannot be reverted!";
    ...
    public partial struct DynamicRequirements
    {
        ...
        public static LocalizedString instructionsfish =
            @"Below are condition lists. If conditions are met on any of the lists then the player can fishing this fish.";

        public static LocalizedString instructionsfishingspot =
            @"Below are condition lists.If the conditions in any of the lists are met, the player can fish in that location.";
...
Tick timer saved in server config.json.";
    ...
    public partial struct MainForm
    {
        ...
        public static LocalizedString fisheseditor = @"Fishes Editor";
